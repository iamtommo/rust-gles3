...
pub fn glBlendEquationSeparatei(
buf: GLuint,
modeRGB: GLenum,
modeAlpha: GLenum,
) -> ();
pub fn glBlendEquationi(
buf: GLuint,
mode: GLenum,
) -> ();
pub fn glBlendFunc(
...
pub fn glDeleteProgramPipelines(
n: GLsizei,
...
pub fn glDispatchCompute(
num_groups_x: GLuint,
num_groups_y: GLuint,
num_groups_z: GLuint,
) -> ();
pub fn glDispatchComputeIndirect(
indirect: GLintptr,
) -> ();
pub fn glDrawArrays(
mode: GLenum,
...
pub fn glFramebufferParameteri(
target: GLenum,
pname: GLenum,
param: GLint,
) -> ();
...
pub fn glGetFramebufferParameteriv(
target: GLenum,
pname: GLenum,
params: *mut GLint,
) -> ();
pub fn glGetGraphicsResetStatus(
) -> GLenum;
...
pub fn glMemoryBarrier(
barriers: GLbitfield,
) -> ();
pub fn glMemoryBarrierByRegion(
barriers: GLbitfield,
) -> ();
pub fn glMinSampleShading(
value: GLfloat,
) -> ();
...
pub fn glValidateProgramPipeline(
pipeline: GLuint,
) -> ();
